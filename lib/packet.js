...
exports.parserPacket = function (buf, fromServer) {
  ...
  if (flag & 0b10) { // Reset Packet
    ...
    return new ResetPacket(flag, connectionId, tags.RNON, packetNumber, tags.CADR)
  }
  ...
  if (version && fromServer) { // Negotiation Packet
    ...
    return new NegotiationPacket(flag, connectionId, versions)
  }
