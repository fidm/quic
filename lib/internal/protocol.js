...
exports.MaxStreamBufferSize = 1400 // todo
...
/**
 * Returns supported versions array.
 * @return {Array<string>} supported versions
 */
...
/** BaseProtocol representing a base protocol. */
class BaseProtocol {
  /**
   * @param {Buffer} buf
   */
...
class PacketNumber extends BaseProtocol {
  ...
  /**
   * @param {PacketNumber} a
   * @param {PacketNumber} b
   * @return {PacketNumber}
   */
  closestTo (a, b) {
