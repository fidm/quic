...
export class QuicError extends Error {
  ...
  constructor (nameOrCode: string | number) {
    const error = errors[nameOrCode] == null ? INVALID_ERROR : errors[nameOrCode]
...
export class QuicStreamError extends Error {
  ...
  code: number
  constructor (nameOrCode: string | number) {
    const error = streamErrors[nameOrCode] == null ? INVALID_RST_STREAM_ERROR : streamErrors[nameOrCode]
